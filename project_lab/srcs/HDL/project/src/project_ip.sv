...
# (
    ...
    localparam integer MRAM_DATA_WIDTH = 8,
...
(
    ...
    reg  [MRAM_DATA_WIDTH-1:0]       wh0_din;
    wire [MRAM_DATA_WIDTH-1:0]       wh0_dout;
    ...
    reg  [MRAM_DATA_WIDTH-1:0]       wh1_din;
    wire [MRAM_DATA_WIDTH-1:0]       wh1_dout;
    ...
    reg  [MRAM_DATA_WIDTH-1:0]       wo_din;
    wire [MRAM_DATA_WIDTH-1:0]       wo_dout;
    ...
    reg  [MRAM_DATA_WIDTH-1:0]       xr_din;
    wire [MRAM_DATA_WIDTH-1:0]       xr_dout;

    // ---- Accelerator handshake ----
    reg  acc_start;
    wire acc_done;
    wire [MRAM_DATA_WIDTH-1:0] acc_result;
            ...
            case (state)
                ...
                begin
                    ...
                    begin
                        ...
                        begin
                            ...
                            wh0_din      <= s_axis_tdata[MRAM_DATA_WIDTH-1:0];
                        end
                        else // col-1
                        begin
                            wh1_write_en <= 1'b1;
                            wh1_waddr    <= wptr_div2[WIDTH_W_HIDDEN-1:0];
                            wh1_din      <= s_axis_tdata[MRAM_DATA_WIDTH-1:0];
                        end
                ...
                begin
                    ...
                    begin
                        ...
                        wo_din       <= s_axis_tdata[MRAM_DATA_WIDTH-1:0];
                ...
                begin
                    ...
                    begin
                        ...
                        xr_din       <= s_axis_tdata[MRAM_DATA_WIDTH-1:0];
                ...
                begin
                    ...
                    begin
                        m_axis_tvalid <= 1'b1;
                        m_axis_tdata  <= {{(DATA_WIDTH-MRAM_DATA_WIDTH){1'b0}}, acc_result};
