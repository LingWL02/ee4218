...
overlay = Overlay('./xx.xsa')
dma_hdl = overlay.axi_dma_0  # adjust if your DMA instance name differs
dma_hls = overlay.axi_dma_1  # adjust if your DMA instance name differs
dma_hls_unoptim = overlay.axi_dma_2  # adjust if your DMA instance name differs
...
# --- Run DMA ---
for dma in [dma_hdl, dma_hls, dma_hls_unoptim]:
    print(f"Testing DMA: {dma.name}")
    start = time.time()
